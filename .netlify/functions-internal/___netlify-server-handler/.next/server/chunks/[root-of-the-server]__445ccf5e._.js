module.exports=[918622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},556704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},832319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},324725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},270406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},193695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},964202,e=>{"use strict";var t=e.i(747909),r=e.i(174017),a=e.i(996250),n=e.i(759756),s=e.i(561916),o=e.i(114444),i=e.i(837092),l=e.i(869741),u=e.i(316795),d=e.i(487718),c=e.i(995169),p=e.i(47587),h=e.i(666012),R=e.i(570101),x=e.i(626937),E=e.i(10372),g=e.i(193695);e.i(52474);var w=e.i(600220),f=e.i(89171),v=e.i(843793);async function m(e){try{let t,{userId:r,amount:a,phone:n,networkId:s,networkName:o,planName:i,planSize:l,planPrice:u}=await e.json();if(!r||!a||!n||!s||!i||!l)return f.NextResponse.json({success:!1,error:"Missing required fields"},{status:400});let d=await v.sql`
      SELECT wallet_balance FROM users WHERE id = ${r}
    `;if(0===d.length)return f.NextResponse.json({success:!1,error:"User not found"},{status:404});let c=Number(d[0].wallet_balance);if(u>c)return f.NextResponse.json({success:!1,error:"Insufficient wallet balance"},{status:400});let p="string"==typeof i&&i.toLowerCase().includes("airtime")?"AIRTIME":"DATA",h=`${p}_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,R=await v.sql`
    ...
    `;return R.length>0?t=R[0].id:(t=`WALLET_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`.toUpperCase(),await v.sql`
      ...
      INSERT INTO transactions (
        ...
        ${h},
        'WALLET',
        ${JSON.stringify({description:`${"AIRTIME"===p?"Airtime":"Data bundle"} purchase: ${i} ${l}`,networkId:s,network:o,phoneNumber:n,plan:`${i} ${l}`})}::jsonb,
        NOW(),
        NOW()
      )
    `,await v.sql`
