// Migration runner for eSIM tables
...
CREATE INDEX IF NOT EXISTS idx_gift_card_products_active ON gift_card_products(is_active);
...
`;
    ...
    console.log('Running migration: 008_add_pricing_tables.sql...');
    ...
    const tables = await pool.query(`
      ...
      AND table_name IN ('esim_phone_plans', 'esim_data_packages', 'gift_card_products', 'proxy_pricing')
    `);
    ...
    const counts = await pool.query(`
      SELECT 'esim_phone_plans' as table_name, COUNT(*) as count FROM esim_phone_plans
      UNION ALL
      SELECT 'esim_data_packages', COUNT(*) FROM esim_data_packages
      UNION ALL
      SELECT 'gift_card_products', COUNT(*) FROM gift_card_products
      UNION ALL
      SELECT 'proxy_pricing', COUNT(*) FROM proxy_pricing
    `);
