-- Run this in the Neon SQL Editor (console.neon.tech) with the neondb_owner role
-- Creates the smspva_services table and seeds all 51 international services
...
GRANT ALL ON TABLE smspva_services TO authenticator;

-- Step 2: Seed all 51 services (upsert — safe to re-run)
