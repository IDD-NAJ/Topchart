...
async function createAdminAccount() {
  ...
  try {
    ...
    // First, drop the problematic updatedAt column if it exists
    try {
      ...
      console.log('⚠️  Could not drop updatedAt column (may not exist):', error.message);
    }
    
    // Delete any existing admin account to avoid conflicts
    ...
    // Create admin user - only include columns that actually exist
