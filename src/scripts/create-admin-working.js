...
async function createAdminAccount() {
  ...
  try {
    ...
    // Step 1: Disable all triggers and drop problematic column
    console.log('🔧 Disabling triggers and dropping updatedAt column...');
    try {
      await sql`DROP TRIGGER IF EXISTS update_users_updated_at`;
    ...
    try {
      ...
      console.log('✅ updatedAt column dropped');
    } catch (error) {
    ...
    try {
      ...
      console.log('✅ updatedAt constraint dropped');
    } catch (error) {
