-- Migration: Create missing admin tables (networks, referrals, data_bundle_purchases)
-- Created: 2026-05-17
...
CREATE INDEX IF NOT EXISTS idx_data_bundle_purchases_status ON data_bundle_purchases(status);
CREATE INDEX IF NOT EXISTS idx_data_bundle_purchases_created_at ON data_bundle_purchases(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_data_bundle_purchases_recipient_phone ON data_bundle_purchases(recipient_phone);
