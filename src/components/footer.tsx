...
import { Twitter, Linkedin, Mail, MapPin, Phone, ArrowUpRight, Sparkles, MessageCircle } from "lucide-react"
  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/dashboard/verification", label: "Foreign Numbers" },
                ...
                {contactInfo.map((item, index) => (
                  ...
                  >
                    ...
                    {"href" in item && item.href ? (
                      <a href={item.href} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">{item.text}</a>
                    ) : (
                      <span>{item.text}</span>
                    )}
                  </motion.li>
