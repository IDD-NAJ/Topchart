    ...
    const verify = async (): Promise<void> => {
      ...
      try {
        ...
        if (data?.success && status === "success") {
          setPhase("success")
          router.replace(`/dashboard/proxies?payment_success=true&reference=${encodeURIComponent(reference)}`)
          return
        }
        ...
        <CardContent className="p-8">
          {phase === "verifying" || phase === "pending" ? (
            ...
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-sm text-muted-foreground">Taking you back to your proxies.</p>
            </div>
          ) : (
...
export default function ProxyPurchaseCallbackPage() {
  return (
    <Suspense
      fallback={
