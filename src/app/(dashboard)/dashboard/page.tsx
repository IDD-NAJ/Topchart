...
const services = [

  {
    ...
    hoverColor: "group-hover:border-[#2563EB]/30"
...

  {
    ...
    color: "text-[#60A5FA] bg-[#EFF6FF]",

    hoverColor: "group-hover:border-[#60A5FA]/30"
...

  {
    ...
    hoverColor: "group-hover:border-[#F59E0B]/30"
    ...
    <Suspense fallback={<Loading />}>
      ...
      >
                ...
                <Card className="bg-muted/30 border-dashed">
                  ...
                  <CardContent className="p-4 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <PiggyBank className="w-4 h-4 text-[#60A5FA]" />
          ...
          >
            ...
            <Card className="flex flex-col justify-between h-full">
              ...
              <div className="px-6 pb-6 pt-2">
                ...
                <div className="p-3 rounded-lg bg-[#2563EB]/5 border border-[#2563EB]/10">

                  <div className="flex items-center gap-2 mb-2">

                     <Zap className="w-3 h-3 text-[#2563EB]" />

                     <span className="text-[10px] font-bold uppercase text-[#2563EB]">Pro Tip</span>
                ...
                <CardContent className="p-0">
                  ...
                  {processingPurchases.length === 0 ? (
                    ...
                    <div className="p-8 text-center space-y-3">
                      ...
                      <div className="w-12 h-12 rounded-full bg-[#2563EB]/10 flex items-center justify-center mx-auto">
                        ...
                        <div key={tx.id} className="p-4 flex items-center justify-between hover:bg-muted/10 transition-colors">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className={cn(
                              ...
                              tx.type === "deposit" ? "bg-[#2563EB]/10 text-[#2563EB]" : "bg-[#60A5FA]/10 text-[#60A5FA]"
                          ...
                          <div className="text-right">
                            ...
                            <p className={cn("text-sm font-bold", tx.type === "deposit" ? "text-[#2563EB]" : "text-foreground")}>
                            ...
                            <Badge variant={tx.status === "success" ? "outline" : "secondary"} className={cn(
                              ...
                              tx.status === "success" ? "text-[#2563EB] bg-[#EFF6FF]/80 border-[#2563EB]/20" : "text-amber-600 bg-amber-50/50"
                      ...
                      {beneficiaries.slice(0, 4).map((b) => (
                        ...
                        <div key={b.phone_number} className="flex items-center justify-between p-3 rounded-lg border border-border/50 bg-muted/5">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="w-8 h-8 rounded-full bg-[#2563EB]/10 text-[#2563EB] flex items-center justify-center text-xs font-bold">
                          ...
                          <div className="flex gap-1.5">
                            ...
                            <Button asChild size="icon" variant="ghost" className="h-7 w-7 rounded-full text-[#2563EB] hover:text-[#1D4ED8] hover:bg-[#EFF6FF]">
                            ...
                            <Button asChild size="icon" variant="ghost" className="h-7 w-7 rounded-full text-[#60A5FA] hover:text-[#2563EB] hover:bg-[#EFF6FF]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           <Card className="bg-[#2563EB]/5 border-[#2563EB]/10 overflow-hidden relative">

             <div className="absolute top-0 right-0 p-8 opacity-5 -mr-4 -mt-4 rotate-12">

                <Gift className="w-32 h-32 text-[#2563EB]" />
             ...
             <CardContent className="space-y-4">
               ...
               <div className="flex items-center justify-between p-3 rounded-lg bg-background border border-[#2563EB]/20">
               ...
               <div className="grid grid-cols-2 gap-3">
                 ...
                 <div className="p-3 rounded-lg bg-background border border-border">
                   ...
                   <p className="text-lg font-bold text-[#2563EB]">{formatCurrency(referralStats?.totalEarnings || 0)}</p>
                 ...
                 <div className="p-3 rounded-lg bg-background border border-border">
                   ...
                   <p className="text-lg font-bold text-[#F59E0B]">{referralStats?.qualifiedReferrals || 0}</p>
