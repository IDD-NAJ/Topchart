...
import { dataPlans, detectNetwork, type Network, type DataPlan } from "@/lib/networks"
...
import { AlertCircle, CheckCircle2, Loader2, Phone, ArrowLeft, Wifi, Star, Zap, ShieldCheck, Target, CreditCard, Users, History } from "lucide-react"
...
export default function DataPage() {
  ...
  const allNetworkPlans = useMemo(() => {

    if (!selectedNetwork) return []

    return dataPlans.filter((plan) => plan.networkId === selectedNetwork.id)
              ...
              <div className="bg-gradient-to-r from-[#006994] to-[#1A85B8] p-8 text-white relative">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/80 text-sm">Review your data synchronization request details.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-6 border-y border-white/10">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-white/60">Data Payload</p>
              ...
              <CardContent className="p-8 bg-background">
                ...
                <div className="mt-6 p-4 rounded-xl bg-muted/50 border border-dashed flex items-start gap-3">
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    ...
                    By clicking "Confirm & Synchronize", you authorize an immediate debit from your wallet and initiation of the data payload delivery protocol. This action is irreversible once broadcast to the network.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   ...
                   <Card className="md:col-span-2">
                     ...
                     <CardHeader className="pb-4 border-b bg-muted/20">
                        ...
                        <CardDescription>Select the destination infrastructure for this data payload.</CardDescription>
                   ...
                   <Card className="md:col-span-1">
                     ...
                     <CardHeader className="pb-4 border-b bg-muted/20">
                        ...
                        <CardDescription>Target MSISDN for the data synchronization.</CardDescription>
