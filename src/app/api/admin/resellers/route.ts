      ...
      if (status !== "all" && search) {
        resellers = await sql`
          SELECT 
            ...
            rp.business_phone,
            rp.reseller_code,
            rp.commission_rate::numeric,
            rp.discount_rate::numeric,
            rp.wallet_balance::numeric,
            rp.total_sales::numeric,
            rp.total_commission_earned::numeric,
            rp.total_referrals::int,
            rp.status,
            rp.bank_account_name,
