...
export const metadata: Metadata = {
  title: 'Cheap Data Bundles Takoradi | Buy Data Online Takoradi Ghana',
  description: 'Buy cheap data bundles in Takoradi, Ghana. MTN, Telecel, AirtelTigo data bundles at lowest prices. Instant delivery via MoMo. Serving all Takoradi areas.',
  keywords: [
    'cheap data bundles Takoradi',
    'buy data online Takoradi',
    'MTN data Takoradi',
    'Telecel data Takoradi',
    'AirtelTigo data Takoradi',
    'cheap internet Takoradi',
    'data bundles Ghana',
    'Takoradi data deals',
    'buy MTN data Takoradi',
    'instant data delivery Takoradi',
    'non-expiry data Takoradi',
    'Takoradi digital services',
  ],
  alternates: { canonical: 'https://topchart.store/cheap-data-takoradi' },
  openGraph: {
    title: 'Cheap Data Bundles Takoradi | Buy Data Online Takoradi Ghana',
    description: 'Buy cheap data bundles in Takoradi, Ghana. MTN, Telecel, AirtelTigo data at lowest prices. Instant delivery via MoMo.',
    url: 'https://topchart.store/cheap-data-takoradi',
    type: 'website',
  },
}

export default function TakoradiDataLandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-neutral-600 leading-relaxed">
                Buy cheap data bundles in Takoradi, Ghana. MTN, Telecel, AirtelTigo data bundles at lowest prices. Instant delivery via MoMo. Serving all Takoradi neighborhoods including Sekondi, Effia, Kansaworado, and more.
              </p>
      ...
      <section className="border-b border-neutral-200/40 px-4 py-20 sm:px-6 bg-neutral-50">
        <div className="mx-auto max-w-[1200px]">
          <h2 className="text-center text-3xl font-bold text-neutral-900 sm:text-4xl">
            Why Takoradi Residents Choose Topchart
          </h2>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                icon: Shield,
                title: 'Lowest Prices',
                description: 'Cheapest data bundles in Takoradi. Lower than carrier rates.',
              },
              {
                icon: CheckCircle,
                title: 'All Networks',
