...
export const metadata: Metadata = {
  title: 'Cheap Data Bundles Tamale | Buy Data Online Tamale Ghana',
  description: 'Buy cheap data bundles in Tamale, Ghana. MTN, Telecel, AirtelTigo data bundles at lowest prices. Instant delivery via MoMo. Serving all Tamale areas.',
  keywords: [
    'cheap data bundles Tamale',
    'buy data online Tamale',
    'MTN data Tamale',
    'Telecel data Tamale',
    'AirtelTigo data Tamale',
    'cheap internet Tamale',
    'data bundles Ghana',
    'Tamale data deals',
    'buy MTN data Tamale',
    'instant data delivery Tamale',
    'non-expiry data Tamale',
    'Tamale digital services',
  ],
  alternates: { canonical: 'https://topchart.store/cheap-data-tamale' },
  openGraph: {
    title: 'Cheap Data Bundles Tamale | Buy Data Online Tamale Ghana',
    description: 'Buy cheap data bundles in Tamale, Ghana. MTN, Telecel, AirtelTigo data at lowest prices. Instant delivery via MoMo.',
    url: 'https://topchart.store/cheap-data-tamale',
    type: 'website',
  },
}

export default function TamaleDataLandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-neutral-600 leading-relaxed">
                Buy cheap data bundles in Tamale, Ghana. MTN, Telecel, AirtelTigo data bundles at lowest prices. Instant delivery via MoMo. Serving all Tamale neighborhoods including Lamashegu, Nyohini, and more.
              </p>
      ...
      <section className="border-b border-neutral-200/40 px-4 py-20 sm:px-6 bg-neutral-50">
        <div className="mx-auto max-w-[1200px]">
          <h2 className="text-center text-3xl font-bold text-neutral-900 sm:text-4xl">
            Why Tamale Residents Choose Topchart
          </h2>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                icon: Shield,
                title: 'Lowest Prices',
                description: 'Cheapest data bundles in Tamale. Lower than carrier rates.',
              },
              {
                icon: CheckCircle,
                title: 'All Networks',
