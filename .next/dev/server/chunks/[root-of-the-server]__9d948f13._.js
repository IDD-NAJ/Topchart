...
"[project]/src/app/api/content/posts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      SELECT id, name, color_class, sort_order
      FROM blog_categories
      ORDER BY sort_order ASC, created_at ASC
    `;
        const posts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      SELECT 
        p.id, 
        p.slug, 
        p.title, 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d948f13._.js.map