...
"[project]/src/lib/actions/dashboard.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"4007e3bddfa6e9fd401b19a8edbb604cf689e76bcc":"getDashboardData"},"",""] */ __turbopack_context__.s([
    "getDashboardData",
    ()=>getDashboardData
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/server-reference.js [app-route] (ecmascript)");
...
async function getDashboardData(options) {
    ...
    const [totalsResult, recentRaw, processingRaw, beneficiariesResult] = await Promise.all([
        // 1. Totals Summary
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      SELECT
    ...
    const beneficiaries = beneficiariesResult.map((row)=>({
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getDashboardData, "4007e3bddfa6e9fd401b19a8edbb604cf689e76bcc", null);
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dashboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions/dashboard.ts [app-route] (ecmascript)");
;
;
...
async function GET() {
    try {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dashboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDashboardData"])({
            recentLimit: 5,
            beneficiaryLimit: 4
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6fe9b391._.js.map