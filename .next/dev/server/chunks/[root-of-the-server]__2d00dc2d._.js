...
"[project]/src/lib/actions/tickets.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"00484ab3ef3d741b46ae8b04809b7f88dfa6a9cb96":"getTickets","401a43ae6b21dfcbf6394f9dc59ee3ac091e7fa448":"getTicketById","40e6cd23ff9db2fe2abc5ac711d9a0c6b669119b0e":"createTicket","6004b5560a9372730b17fdf40f74dc0544bd75996f":"sendTicketMessage"},"",""] */ __turbopack_context__.s([
    "createTicket",
    ()=>createTicket,
    "getTicketById",
    ()=>getTicketById,
...
async function getTickets() {
    ...
    const tickets = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
    SELECT * FROM tickets 
...
async function getTicketById(id) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentUser"])();
    if (!user) throw new Error("Unauthorized");
    const ticketResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
    SELECT * FROM tickets 
    WHERE id = ${id} AND "userId" = ${user.id}
  `;
    if (!ticketResult || ticketResult.length === 0) return null;
    const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
...
async function createTicket(data) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentUser"])();
    if (!user) throw new Error("Unauthorized");
    const ticketId = `TKT-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["nanoid"])(10).toUpperCase()}`;
    const now = new Date();
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
  ...
  `;
    const messageId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["nanoid"])();
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
...
async function sendTicketMessage(ticketId, body) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentUser"])();
    if (!user) throw new Error("Unauthorized");
    // Verify ownership
    const ticketResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getTickets, "00484ab3ef3d741b46ae8b04809b7f88dfa6a9cb96", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getTicketById, "401a43ae6b21dfcbf6394f9dc59ee3ac091e7fa448", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(createTicket, "40e6cd23ff9db2fe2abc5ac711d9a0c6b669119b0e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(sendTicketMessage, "6004b5560a9372730b17fdf40f74dc0544bd75996f", null);
}),
"[project]/src/app/api/dashboard/tickets/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$tickets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions/tickets.ts [app-route] (ecmascript)");
;
;
async function GET(req, { params }) {
    try {
        const { id } = await params;
        const ticket = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$tickets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTicketById"])(id);
        if (!ticket) {
...
async function POST(req, { params }) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$tickets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendTicketMessage"])(id, body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            ...result
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d00dc2d._.js.map